            ...
            <div className="container">
                <div className={styles.inner}>
                    <div className={styles.brand}>
                        ...
                        <div>
                            <div className={styles.name}>Abhishek Bajpai</div>
                    ...
                    <div className={styles.social}>
                        ...
                        <a href="mailto:abhishek@example.com" className={styles.socialLink} aria-label="Email">
                ...
                <div className={styles.bottom}>
                    <span>© {new Date().getFullYear()} Abhishek Bajpai. All rights reserved.</span>
